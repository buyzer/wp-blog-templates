...
function wpbtpls_add_template() {
	...
	$show_date = (int)sanitize_text_field( $_POST['show_date'] );  
	$date_format = sanitize_text_field( $_POST['date_format'] );  
	$show_excerpt = (int)sanitize_text_field( $_POST['show_excerpt'] );  
	$excerpt_length = (int)sanitize_text_field( $_POST['excerpt_length'] );  
	$show_readmore = (int)sanitize_text_field( $_POST['show_readmore'] );  
